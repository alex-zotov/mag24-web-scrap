...
**git-api.** Библиотека requests. Получить список репозиториев для пользователя и сохранить как json.
[./git-api-request/2025-10-15-git.ipynb](./git-api-request/2025-10-15-git.ipynb)
